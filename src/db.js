...
const VeryCoolSchema = new Schema({
    ...
    ServerID: { type: String, default: '1102707794295136287' },
    MutedRoleID: { type: String , default: '1118478796560015371'},
    MuteDurationMinute: { type: Number, default: 15 },
    PunishLogChannelID: { type: String, default: '1120270825304625213' },
    FiltredWords:  { type: Array, default: ["amq", "oc", "orospu cocuğu", "oç", "aq", "orospu", "orspu", "orospucocu","orospu cocugu", "orospu evladı", "orospunun dogurdugu", "orospunun kızı", "orospunun oglu", "orospunun sıctıgı","Oorospucou","Anen","anskm", "orosbu", "orosb", "0r0spuc0cu", "4n4n1 sk3r1m", "p1c", "@n@nı skrm", "evladi", "orsb", "orsbcogu", "amnskm", "anaskm", "mk", "oc", "abaza", "abazan", "ag", "ağzına sıçayım", "fuck",
    ...
    "viagra", "vulva", "w00se", "wang", "wank", "wanker", "wanky", "whoar", "whore", "willies", "willy", "xrated", "xxx","amini","Anan","Ananı","annanı","annen"] },
    WhiteListMembers:  { type: Array, default: ["852537099722948628", "1109514213895966821", "900720172053180416"] },
    WhiteListRoles:  { type: Array, default: ["1118449617961488456"] },
    WhiteListChannels:  { type: Array, default: [] },
    BlueListMembers: { type: Array, default: [] },
    BlackListMembers: { type: Array, default: [] },
    CharacterLimit: { type: Boolean, default: true }, 
    InviteGuard: { type: Boolean, default: true }, 
    LinkGuard: { type: Boolean, default: true }, 
    MassPingGuard: { type: Boolean, default: true }, 
    BadWordGuard: { type: Boolean, default: true }, 
    SpamGuard: { type: Boolean, default: true }
});
